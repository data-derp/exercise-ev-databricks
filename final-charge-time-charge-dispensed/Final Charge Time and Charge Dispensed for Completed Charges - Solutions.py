...
from exercise_ev_databricks_unit_tests.final_charge_time_charge_dispensed_completed_charges import test_get_most_recent_energy_active_import_register_unit
...
# MAGIC Recall our original question: **How much total charge has been dispensed for every completed transaction for a given month?**
# MAGIC 
...
# MAGIC Recall our original question: **How much total charge has been dispensed for every completed transaction for a given month?**
# MAGIC 
# MAGIC In addition to delivering a CSV artifact as we did in the last exercise, we can also visualise it in a graph or chart.
# MAGIC 
# MAGIC 
